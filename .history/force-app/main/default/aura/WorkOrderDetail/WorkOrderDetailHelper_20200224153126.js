({
    getWOJobs : function(component, event, helper) {
        ...
        getjobs.setCallback(this, function(response){
            console.log('---------------wojwithJLI',response.getReturnValue());
    ...
    taxCalculation : function(component, event, helper){
        ...
        if(typeof storeLocation != "undefined"){
            ...
            var woJobWithJL = component.get("v.woJobsWithWJL");
            if(typeof storeLocation == "undefined" && woJobWithJL.length > 0 && typeof woJobWithJL[0].objWOJ.BOATBUILDING__Work_Order_Warranty_Work_Order__r.BOATBUILDING__Store_Location__c != "undefined"){
                storeLocation = woJobWithJL[0].objWOJ.BOATBUILDING__Work_Order_Warranty_Work_Order__r.BOATBUILDING__Store_Location__c;
            }
            var salestaxConfig;
            if(typeof woJobWithJL != "undefined" && woJobWithJL.length > 0 &&  typeof woJobWithJL[0].salesTaxConfig != "undefined"){
